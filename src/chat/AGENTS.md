...
- Quando a resposta do NPC depender de trabalho longo no backend, mostre progresso vivo no modal: fase atual, heartbeat, tempo decorrido e eventos recentes. Um placeholder unico nao comunica confiabilidade.
